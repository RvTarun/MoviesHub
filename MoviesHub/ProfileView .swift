            ...
            ScrollView {
                VStack(alignment: .center) {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        .padding(EdgeInsets(top: -130, leading: 1, bottom: -130, trailing: 1))
                    }
                    Divider()
                    ...
                    VStack(alignment: .leading) {
                        ...
                        .padding(EdgeInsets(top: -130, leading: 1, bottom: -100, trailing: 1))
                    }

                    // ── Friends & Watch Together ── NEW ───────────────
                    NavigationLink {
                        FriendView()
                    } label: {
                        Text("\(Image(systemName: "person.2.fill")) Friends & Watch Together")
                            .font(.headline)
